...
| skills_architecture.md | **架构与设计**（82 个） |
| skills_business.md | **商业与营销**（56 个） |
| skills_data-ai.md | **数据与 AI**（233 个） |
| skills_development.md | **开发与实现**（180 个） |
| skills_general.md | **通用与综合**（299 个） |
| skills_infrastructure.md | **基础设施与运维**（136 个） |
| skills_security.md | **安全与合规**（149 个） |
| skills_testing.md | **测试与质量**（35 个） |
| skills_workflow.md | **工作流与协作**（95 个） |
| [Android_开发相关_Skills.md](../../02-场景分析/Android_开发相关_Skills.md) | **Android 开发**：适用于 Android 系统开发的技能汇总（见场景分析） |
