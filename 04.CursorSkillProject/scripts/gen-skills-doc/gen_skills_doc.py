...
# ── 路径 ──────────────────────────────────────────────
BASE_DIR   = Path(__file__).parent.parent  # 02-脚本/ 的上一级即项目根目录
CATALOG    = BASE_DIR / "03-第三方技能" / "antigravity-awesome-skills" / "CATALOG.md"
OUT_DIR    = BASE_DIR / "01-文档" / "04-第三方技能索引" / "antigravity-awesome-skills"
