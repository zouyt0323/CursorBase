...
| 网站                  | 地址                                                       | 收录数量        | 特点                       |
| ------------------- | -------------------------------------------------------- | ----------- | ------------------------ |
| **MCP.so**          | [mcp.so](https://mcp.so/)                                | 18,070+     | 最大的 MCP 市场，有调用排行榜        |
| **Smithery.ai**     | [smithery.ai/servers](https://smithery.ai/servers)       | 3,500+      | 提供安装量统计                  |
| **PulseMCP**        | [pulsemcp.com/servers](https://www.pulsemcp.com/servers) | 8,600+      | 每日更新，下载量估算，过滤低质量实现       |
...
| 仓库                                                                                      | Stars    | 说明                       |
| --------------------------------------------------------------------------------------- | -------- | ------------------------ |
| **[punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)**     | ⭐ 82,180 | 最权威的社区 MCP 收集仓库          |
...
| --- | ----------------------- | ------ | -------------------------- | ---------------------- |
| 1   | **Playwright**          | 浏览器自动化 | PulseMCP 1.4M 周访问          | Microsoft，AI 控制浏览器     |
| 2   | **Context7**            | 代码文档   | PulseMCP 592k 周访问          | 实时拉取最新库文档              |
| 3   | **Chrome DevTools**     | 浏览器调试  | PulseMCP 448k 周访问          | Google 官方，浏览器开发者工具     |
| 4   | **Claude Flow**         | 推理增强   | PulseMCP 382k 周访问          | 多 Agent 编排与工作流         |
| 5   | **GitHub**              | 开发工具   | PulseMCP 4.7M 总下载 / 77.1k 周 | GitHub 仓库、Issue、PR     |
...
| 指标                      | 数据                                                         |
| ----------------------- | ---------------------------------------------------------- |
| PulseMCP 收录（每日更新，过滤低质量） | **8,600+**                                                    |
| MCP.so 收录（含全部）          | **18,070+**                                                   |
| Glama.ai 收录             | **5,800+**                                                    |
| MCP 客户端应用               | **300+**（含 Claude Desktop、VS Code、Cursor 等）                  |
| 主要开发语言                  | Python > TypeScript > JavaScript                              |
| 头部 MCP 服务周访问量           | Playwright 1.4M / Context7 592k / Chrome DevTools 448k        |
| MCP 协议发布时间              | 2024 年 11 月（Anthropic 发布）                                    |
| 最大社区收集仓库                | punkpeye/awesome-mcp-servers（⭐82,180+）                       |
